...
- [walk](https://op12no2.github.io/naddu/examples/walk.html) - a random walk over the search parameters, each candidate plays the current best on a clock, a toy tuner.
